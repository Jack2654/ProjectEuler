...
public class P54 {
    ...
    //NOTE: case where both have pair but value the same not implemented here

    private class Hand
    {
        private String[] myCards;
        private ArrayList<String> myCs;
        ...
        {
            myCs = new ArrayList<>();
            for(String t : myCards)
            {
                myCs.add(t.substring(0,1));
            }
            royal = isRoyal();
            flush = isFlush();
            straight = isStraight();
            ...
            for(String t : myCs)
            {
                ...
                {
                    myRemaining[i] = Integer.parseInt(t);
                }
                i++;
            }
            Arrays.sort(myRemaining);
            myVal = 0;
        }
        ...
        private void maxFreq()
        {
            ...
            for(String t : myCs)
            {
                int temp = Collections.frequency(myCs, t);
                if(temp == 2)
                {
                    two = true;
                    myPairs++;
            ...
            if(maxCard.equals("A"))
                myMaxV = 14;
            else if(maxCard.equals("K"))
                myMaxV = 13;
            else if(maxCard.equals("Q"))
                myMaxV = 12;
            else if(maxCard.equals("J"))
                myMaxV = 11;
            else if(maxCard.equals("T"))
                myMaxV = 10;
            else myMaxV = Integer.parseInt(maxCard);
        }
        ...
        {
            String[] straight = new String[]{"1", "2", "3", "4", "5"};
            ...
            Arrays.sort(current);
            while(!current[0].equals("0"))
            {
                //System.out.println(Arrays.toString(current));
                if(Arrays.equals(current, straight))
                    return true;
        ...
        private String[] decrease(String[] s)
        {
        ...
        private boolean isRoyal()
        {
            ...
            cards.addAll(myCs);
            return cards.contains("T") && cards.contains("J") && cards.contains("Q") && cards.contains("K") && cards.contains("A");
        }
    }
    ...
    public boolean same(Hand a, Hand b)
    {
        for (int i = a.myRemaining.length - 1; i >= 0; i--) {
            if (a.myRemaining[i] != b.myRemaining[i]) {
                return a.myRemaining[i] > b.myRemaining[i];
            }
        }
        if (a.myPairs != b.myPairs)
            return a.myPairs > b.myPairs;
        if (a.myMaxV != b.myMaxV)
            return a.myMaxV > b.myMaxV;
        return false;
    }
    ...
    public static void main(String[] args)
    {
        ...
        if(true)
        {
            all = "8C TS KC 9H 4S 7D 2S 5D 3S AC\n" +
        ...
        System.out.println(p.count(all));
        //System.out.println(p.win("TC JC QC KC AC 7D 8D 9D TD JD")); //9 + 8
        //System.out.println(p.win("TC TC TC TC AC 7D 7D 7D TD TD")); //7 + 6
        //System.out.println(p.win("1C 5C QC KC AC 7D 8D 9D TC JD")); //5 + 4
        //System.out.println(p.win("TC TC TC KD AC 7D 7D 9C 9S JD")); //3 + 1
        //System.out.println(p.win("1C 2D 5S KC AC 7D 8D 9D TD JD")); //0 + 0

    }
}

// x within [0,1], average number of selections before sum > 1
// P(s > 0) = 1
// P(s > 1) = 1 / 2
// P(s > 2) = 1 / 6
// thus, avg. selections = e